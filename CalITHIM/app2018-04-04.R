...
# Folder for banner photos and CSS file
setwd(paste0(this.dir,"/www"))
...
# Title Panel
  titlePanel("California Integrated Transport and Health Impacts Model - DRAFT - 4 APR 2018"), tags$div(id="top"),
